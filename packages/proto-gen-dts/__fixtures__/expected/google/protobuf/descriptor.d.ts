...
declare namespace google {
  namespace protobuf {
    ...
    // domain.
    export interface google_protobuf_EnumDescriptorProto_EnumReservedRange {
      // Inclusive.
      start?: number;
      // Inclusive.
      end?: number;
    ...
    export interface google_protobuf_SourceCodeInfo_Location {
    ...
    export interface google_protobuf_GeneratedCodeInfo_Annotation {

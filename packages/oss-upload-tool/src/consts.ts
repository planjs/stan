 ...
 * 各个 oss 都有的参数
 */
export const SECRET_ID = 'oss_upload_tool_secret_id';
export const SECRET_KEY = 'oss_upload_tool_secret_key';
...
export const COS_BUCKET_KEY = 'oss_upload_tool_cos_bucket';
export const COS_REGION_KEY = 'oss_upload_tool_cos_region';

// ali-oss
export const ALIOSS_SECRET_ID = 'oss_upload_tool_alioss_secret_id';
export const ALIOSS_SECRET_KEY = 'oss_upload_tool_alioss_secret_key';
